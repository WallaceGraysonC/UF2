...
struct CardView: View {
    ...
    private var cardBackFill: AnyShapeStyle {
        CustomCosmeticFill.style(
            ...
            fallback: AnyShapeStyle(BJTheme.cardBackMaterial(base: CardBackPalette.color(for: cardBackID)))
        )
    }

    private var cardFaceFill: AnyShapeStyle {
        CustomCosmeticFill.style(for: cardFaceID, kind: .cardFace, fallback: AnyShapeStyle(BJTheme.cardMaterial))
    }
}
