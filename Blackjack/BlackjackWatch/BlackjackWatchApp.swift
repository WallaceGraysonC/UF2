...
/// no Game Center, no matchmaking -- just you, a few bots, and the dealer,
/// sized for a wrist screen. Every cosmetic equipped on the phone (card
/// faces, felt, avatars, ...) renders here too, since it all reads from the
/// same shared `BankrollManager`.
///
...
/// Membership list):
///   Card.swift, Shoe.swift, BlackjackHandEvaluator.swift, Player.swift,
///   DealerHand.swift, GameState.swift, BlackjackEngine.swift,
///   EngineSnapshot.swift, GamePersistence.swift, BlackjackBotAI.swift,
///   BotNames.swift, Cosmetic.swift, CosmeticPalettes.swift,
///   CustomCosmeticStore.swift, BankrollManager.swift, BJTheme.swift
