...
/// Shared palette and type scale for Launch Day.
enum Theme {
    ...
    /// Backdrop behind the studio scene — deep, so painted panels pop off it.
    ...
    /// Mono face for labels, stats, and body copy.
