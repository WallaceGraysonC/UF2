...
final class GameCenterManager: NSObject, ObservableObject {
    ...
    func makeMatchmakerViewController(minPlayers: Int = 2, maxPlayers: Int = 8, delegate: GKMatchmakerViewControllerDelegate) -> GKMatchmakerViewController? {
    ...
    /// Sends data to a single remote participant -- used to broadcast
    /// personalized game states that hide other players' hole cards.
